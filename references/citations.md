...
| Tiêu chí | Chế độ 1 (Numerated) | Chế độ 2 (Plain) |
|---|---|---|
| Độ dài bài | 15+ chương | <15 chương hoặc policy |
| Số nguồn | 10-40 nguồn | <15 nguồn |
| Cần truy nguồn số liệu? | ✅ CÓ — mỗi số có [N] | ❌ Không cần |
| Loại bài | Tự nghiên cứu / tư duy | Policy tổng hợp / tổng quan |
| Ví dụ thực tế | bdong-tien, boom-tien | ttck-trung-quoc, giao-duc-trung-quoc |

**Quy tắc:** Nếu bài có nhiều số liệu cụ thể cần minh bạch nguồn → Chế độ 1. Nếu bài là tổng hợp quan điểm/policy → Chế độ 2.
